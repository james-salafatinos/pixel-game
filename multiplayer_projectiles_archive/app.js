...
function init() {
  ...
  octreeWorld = new Octree();
  playerCollider = new Capsule(
    new THREE.Vector3(0, 0.35, 0),
    new THREE.Vector3(0, 1, 0),
    0.35
  );
  octreeWorld.fromGraphNode(scene);

  console.log(octreeWorld);
  console.log(new OctreeHelper(octreeWorld));

  octreeHelper = new OctreeHelper(octreeWorld);
...
function animate() {
  ...
  const result = octreeWorld.capsuleIntersect(playerCollider);
  console.log(result);
