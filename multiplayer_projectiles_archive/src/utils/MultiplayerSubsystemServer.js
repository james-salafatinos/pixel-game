    ...
    this.io.sockets.on("connection", function (socket) {
      ...
      socket.on("ProjectileState", function (data) {
        if (data != null) {
          ...
          if (data.socket_id != undefined) {
            parent.gameProjectileState[data.socket_id] = {
              x: data.x,
              y: data.y,
              z: data.z,
          ...
          console.log("parent gameProjectileState", parent.gameProjectileState);
          // console.log(parent.gameState);
          socket.broadcast.emit(
            `ProjectilePosition`,
            parent.gameProjectileState
          );
